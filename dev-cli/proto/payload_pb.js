...
goog.exportSymbol('proto.pending_props_pb.SettlementData', null, global);
/**
 ...
 * @constructor
 */
proto.pending_props_pb.SettlementData = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pending_props_pb.SettlementData, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pending_props_pb.SettlementData.displayName = 'proto.pending_props_pb.SettlementData';
}
 ...
 * @return {string}
 */
proto.pending_props_pb.BalanceUpdate.prototype.getFromAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};


/** @param {string} value */
proto.pending_props_pb.BalanceUpdate.prototype.setFromAddress = function(value) {
 ...
 * @return {!Object}
 */
proto.pending_props_pb.SettlementData.prototype.toObject = function(opt_includeInstance) {
  return proto.pending_props_pb.SettlementData.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pending_props_pb.SettlementData} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pending_props_pb.SettlementData.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pending_props_pb.SettlementData}
 */
proto.pending_props_pb.SettlementData.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pending_props_pb.SettlementData;
  return proto.pending_props_pb.SettlementData.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pending_props_pb.SettlementData} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pending_props_pb.SettlementData}
 */
proto.pending_props_pb.SettlementData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pending_props_pb.SettlementData.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pending_props_pb.SettlementData.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pending_props_pb.SettlementData} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pending_props_pb.SettlementData.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.pending_props_pb.SettlementData.prototype.getApplicationId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.pending_props_pb.SettlementData.prototype.setApplicationId = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.pending_props_pb.SettlementData.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.pending_props_pb.SettlementData.prototype.setUserId = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.pending_props_pb.SettlementData.prototype.getAmount = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.pending_props_pb.SettlementData.prototype.setAmount = function(value) {
 ...
 * @return {string}
 */
proto.pending_props_pb.SettlementData.prototype.getToAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.pending_props_pb.SettlementData.prototype.setToAddress = function(value) {
 ...
 * @return {string}
 */
proto.pending_props_pb.SettlementData.prototype.getFromAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};


/** @param {string} value */
proto.pending_props_pb.SettlementData.prototype.setFromAddress = function(value) {
  jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @return {string}
 */
proto.pending_props_pb.SettlementData.prototype.getTxHash = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};


/** @param {string} value */
proto.pending_props_pb.SettlementData.prototype.setTxHash = function(value) {
  jspb.Message.setProto3StringField(this, 6, value);
};


/**
 * optional int64 block_id = 7;
 * @return {number}
 */
proto.pending_props_pb.SettlementData.prototype.getBlockId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};


/** @param {number} value */
proto.pending_props_pb.SettlementData.prototype.setBlockId = function(value) {
  jspb.Message.setProto3IntField(this, 7, value);
};
 ...
 * @return {number}
 */
proto.pending_props_pb.SettlementData.prototype.getTimestamp = function() {
